              ...
              <ul className="hidden group-hover:inline-block z-[50] absolute p-2 lg:p-4 rounded-md bg-black text-sm font-poppins">
                <li className=" whitespace-nowrap p-2 flex flex-row gap-1 items-center hover:border-b-[1px] border-indigo-400 w-fit">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.5 3.5H11.5V5.5H13.5V3.5Z" fill="white" fill-opacity="0.85"/>
                    <path d="M13.5 6.5H11.5V8.5H13.5V6.5Z" fill="white" fill-opacity="0.85"/>
                    <path d="M10.5 3.5H8.5V5.5H10.5V3.5Z" fill="white" fill-opacity="0.85"/>
                    <path d="M10.5 6.5H8.5V8.5H10.5V6.5Z" fill="white" fill-opacity="0.85"/>
