...
export async function loader() {
  ...
  const res = await fetch(strapiUrl + "/api/s-cloud-migration?populate=%2A");
  const componentRes = await fetchData(
    "/api/s-cloud-migration/?populate=s2_keyPoints.keyPointsImage,s5_phasesOfDevelopment.s5_phasesImage,s7_techIcons.s7_techIcon,s6_serviceCard.s6_serviceCardImage,s4_industryFocus.s4_IndustryFocusImage"
  );
