...
export async function loader() {
  ...
  const res = await fetch(strapiUrl + "/api/s-dev-op?populate=%2A");
  const componentRes = await fetchData(
    "/api/s-dev-op/?populate=s2_keyPoints.keyPointsImage,s5_phasesOfDevelopment.s5_phasesImage,s7_techIcons.s7_techIcon,s6_serviceCard.s6_serviceCardImage,s4_industryFocus.s4_IndustryFocusImage"
  );
