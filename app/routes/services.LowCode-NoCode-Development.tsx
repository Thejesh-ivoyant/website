...
export const meta: MetaFunction = () => {
  return [
    { title: "Ivoyant | Low Code/No code development  " },
    {
      property: "og:title",
...
export async function loader() {
  ...
  const res = await fetch(strapiUrl + "/api/s-low-code-no-code?populate=%2A");
  const componentRes = await fetchData(
    "/api/s-low-code-no-code/?populate=s2_keyPoints.keyPointsImage,s5_phasesOfDevelopment.s5_phasesImage,s7_techIcons.s7_techIcon,s6_serviceCard.s6_serviceCardImage,s4_industryFocus.s4_IndustryFocusImage"
  );
