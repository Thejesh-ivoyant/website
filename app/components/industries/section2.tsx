  ...
  return (
    <section className="relative flex justify-center flex-col-reverse lg:flex-row max-h-fit overflow-hidden mx-auto">
      <div className="flex flex-1 flex-col lg:min-h-full justify-between">
        ...
        >
          <img
            src={loaderData?.section2Image}
            className=" mx-auto my-auto h-52 lg:h-[26.8rem] aspect-video object-contain px-4"
            alt="ornament"
          />
        </div>
        <div
        ...
        >
          <img
            src={loaderData.section2Image}
            className=" mx-auto my-auto h-52 md:h-[20rem] aspect-video object-contain px-4"
            alt="ornament"
          />
        </div>
      </div>
