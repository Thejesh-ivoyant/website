  ...
  return (
    <>
      <div className="grid place-items-center gap-4 xl:mx-12 lg:mx-8 mx-4 p-7">
        <div className="italic font-montserrat md:mr-0 mr-auto bg-haiti w-fit text-white px-1">{data?.section4MiniTitle}</div>
        <div className="text-PurpBlue md:text-center  font-montserrat md:text-4xl text-3xl font-semibold">{data?.section_4_title}</div>
        ...
        <p className="text-[#262626] md:text-center md:text-xl text-lg font-normal">{data?.section_4_description}</p>
